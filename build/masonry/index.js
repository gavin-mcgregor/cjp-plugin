...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/masonry/editor.scss");
...
function Edit({
  ...
  const [imageList, setImageList] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(images);
  ...
  const onSortEnd = newOrder => {
    const newImages = newOrder.map(item => images.find(img => img.id === item.id));
    setAttributes({
      images: newImages
    });
  };
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.InspectorControls, null, columns && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Image Upload", "masonry")
    ...
    render: ({
      ...
      variant: "primary",
      onClick: open
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Select Images", "masonry"))
  }))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Grid Settings", "masonry")
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Gallery Order", "masonry")
  }, imageList.length > 0 && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_sortablejs__WEBPACK_IMPORTED_MODULE_1__.ReactSortable, {
    list: imageList,
    setList: newOrder => {
  ...
  }, imageList.map(image => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
    key: image.id
    ...
    className: "meta-info"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, "Image ID: ", image.id), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.Button, {
    variant: "secondary",
    onClick: () => removeImage(image.id)
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Remove", "my-image-array-block")))))))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...(0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.useBlockProps)({
      className: ["masonry-container", `col-${columns}`]
    })
  }, images.length > 0 && finalColumns.map((cols, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "col",
    key: `col-${index}`
  }, cols.map(image => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    key: image.id,
    src: image.url,
    alt: image.alt
  }))))));
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/masonry/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/masonry/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/masonry/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/masonry/block.json");
/**
...
function Save({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    alt: image.alt,
    srcset: image.srcset,
    sizes: `(max-width: 980px) 50vw, ${columns === "2" ? "50vw" : "25vw"}`
  })))));
}
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"cjp-blocks/masonry","version":"0.1.0","title":"Gallery","category":"custom-block","example":{},"attributes":{"images":{"type":"array","default":[]},"columns":{"type":"string"},"masonry":{"type":"array","default":[]}},"supports":{"html":false},"textdomain":"masonry","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["masonry/style-index"], () => (__webpack_require__("./src/masonry/index.js")))
